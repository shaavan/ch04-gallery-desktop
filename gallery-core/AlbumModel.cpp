...
QModelIndex AlbumModel::addAlbum(const Album &album)
{
    ...
    beginInsertRows(QModelIndex(), rowIndex, rowIndex); // beginInsertRows(parent, starting_index, ending_index)
...
bool AlbumModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    emit dataChanged(index, index); // datachanged(starting_index, ending_index)
    return true;
}
